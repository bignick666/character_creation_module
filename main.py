...
def start_training(character):
    ...
    commands = {
        'attack': character.__class__.attack(),
        'defence': character.__class__.defence(),
        'special': character.__class__.special()
    }
    ...
    while cmd != 'skip':
        ...
        selected_command: Character = commands[cmd](character)
